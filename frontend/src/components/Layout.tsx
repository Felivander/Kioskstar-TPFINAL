    ...
    <div className="h-screen flex flex-col bg-surface-50 overflow-hidden">
      ...
      <header className="sticky top-0 z-40 bg-white/80 backdrop-blur-md border-b border-surface-200/50 px-4 lg:px-8 py-3.5 flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="hidden sm:flex items-center gap-2.5 px-3 py-1.5 rounded-xl bg-surface-100/60 border border-surface-200/40">
          ...
          <button
            ...
            className="hidden sm:flex items-center gap-1.5 px-3 py-2 text-xs font-medium text-surface-500 hover:text-red-600 hover:bg-red-50 rounded-xl transition-all duration-200"
