        ...
        <div className="flex-1 overflow-y-auto p-4 flex flex-col gap-3 min-h-0">
          ...
          <div className="flex-1 flex flex-col min-h-0">
            ...
            {results && results.length > 0 ? (
              ...
              <div className="flex-1 flex flex-col items-center justify-center py-8 bg-surface-50 rounded-xl border border-surface-100 border-dashed">
                <Package size={20} className="mb-1.5 text-surface-400" />
                <p className="text-[10px] text-surface-400 text-center">No hay stock registrado para búsqueda</p>
              </div>
            )}
          </div>
                        ...
                        {isClosest ? (
                          ...
                          <div className={`flex items-center gap-1 px-2.5 py-1 rounded-full shadow-lg text-xs font-bold cursor-pointer transition-transform hover:scale-110
                            ${selectedBranch?.id === b.id
                              ? 'bg-gradient-to-r from-orange-700 via-orange-500 to-orange-700 text-white scale-110 border border-orange-800/80 shadow-lg shadow-orange-500/30 font-extrabold'
                              : hasResults
